...
map('n', '<F2>', ':GoDebugBreakpoint<CR>', default_opts)
map('n', '<F3>', ':GoDebugTest<CR>', default_opts)
map('n', '<F4>', ':GoDebugStop<CR>', default_opts)
map('n', '<F6>', ':GoDebugRestart<CR>', default_opts)
map('n', '<F7>i', ':GoDebugStep<CR>', default_opts)
map('n', '<F7>o', ':GoDebugStepOut<CR>', default_opts)
map('n', '<F8>', ':GoRun<CR>', default_opts)
